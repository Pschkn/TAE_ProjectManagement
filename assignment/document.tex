...
\textbf{Contributors:} Markus Just, Timo Acquistapace, Simon Schneider }
...
\vspace{-1cm}
\epigraph{\textbf{Author: } Wojciech Lesnianski \newline
\textbf{Contributor:} Markus Just}

\input{contents/chapters/specification.tex}

\chapter{Project Plan}
\vspace{-1cm}
\epigraph{\textbf{Author: } Markus Just \newline
\textbf{Contributor:} Wojciech Lesnianski}

\input{contents/chapters/projectPlan.tex}
...
\setcounter{page}{1}
\pagenumbering{Roman} 
\input{contents/chapters/appendix.tex}
